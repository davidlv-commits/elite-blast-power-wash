...
const translations = {
  en: {
    ...
    "cards.fleet.title": "Fleet & Truck Washing",
    "cards.fleet.copy": "Semis, tractors, trailers, and heavy equipment returned to showroom condition.",
    "fleet.badge": "New service",
    "fleet.eyebrow": "Fleet & commercial",
    "fleet.title": "Built to make your fleet shine",
    "fleet.lead": "From single tractors to full fleets, we wash the detail your drivers notice: cabs, grilles, mirrors, tanks, wheels, steps, and trailers.",
    "fleet.trusted": "Trusted by trucking companies across New Jersey",
    "fleet.cat.owner": "Owner-operators",
    "fleet.cat.logistics": "Logistics fleets",
    "fleet.cat.dump": "Dump & heavy haul",
    "fleet.cat.semis": "Semis & trailers",
    "fleet.cta": "Request a fleet quote",
    "cards.bin.title": "Trash Bin Cleaning and Sanitizing",
    "cards.bin.copy": "Monthly trash can cleaning and sanitizing for $30 per month, once a month all year round.",
    "cards.truck.title": "Truck and Trailer Wash Quotes",
    "cards.truck.copy": "Request a custom quote for trucks, trailers, and truck-and-trailer wash service.",
    "cards.interior.title": "Interior House Cleaning Quotes",
    "cards.interior.copy": "Request a quote for interior house cleaning services tailored to your home.",
    ...
    "contact.copy2": "or email us at",
    "contact.copy3": "Ask about our $30/month trash bin cleaning plan or request a quote for trucks and trailers.",
    "form.name": "Name",
  ...
  es: {
    ...
    "cards.fleet.title": "Lavado de camiones y flota",
    "cards.fleet.copy": "Camiones, tractocamiones, remolques y maquinaria pesada devueltos a estado de concesionario.",
    "fleet.badge": "Nuevo servicio",
    "fleet.eyebrow": "Flota y comercial",
    "fleet.title": "Pensado para que tu flota brille",
    "fleet.lead": "Desde un solo tractocamión hasta flotas completas, cuidamos el detalle que notan tus conductores: cabinas, parrillas, espejos, depósitos, ruedas, escalones y remolques.",
    "fleet.trusted": "Confianza de transportistas en New Jersey",
    "fleet.cat.owner": "Owner-operators",
    "fleet.cat.logistics": "Flotas de logística",
    "fleet.cat.dump": "Dump trucks y transporte pesado",
    "fleet.cat.semis": "Tractocamiones y trailers",
    "fleet.cta": "Solicita presupuesto para flota",
    "cards.bin.title": "Limpieza y desinfección de cubos de basura",
    "cards.bin.copy": "Limpieza y desinfección mensual de cubos por 30 dólares al mes, una vez al mes durante todo el año.",
    "cards.truck.title": "Presupuesto para camiones y remolques",
    "cards.truck.copy": "Pide presupuesto personalizado para lavar camiones, trailers y conjuntos de camión con remolque.",
    "cards.interior.title": "Presupuesto para limpieza interior de casas",
    "cards.interior.copy": "Solicita presupuesto para servicios de limpieza interior adaptados a tu vivienda.",
    ...
    "about.copy": "Elite Blast Power Wash ayuda a mejorar la imagen de tu propiedad con lavados cuidadosos, acabados más limpios y resultados antes/después que realmente se notan.",
    ...
    "about.feature2.copy": "Nuestro trabajo se apoya en mejoras claras de antes/después que se perciben desde la primera visita.",
    ...
    "contact.copy2": "o escríbenos a",
    "contact.copy3": "Pregunta por nuestro plan de limpieza de cubos por 30 dólares al mes o solicita presupuesto para camiones y remolques.",
    "form.name": "Nombre",
